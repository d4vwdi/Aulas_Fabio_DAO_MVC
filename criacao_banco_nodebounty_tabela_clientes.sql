...
INSERT INTO `nodebounty`.`clientes` (cpf, email, endereco, cep, rg, datanascimento, senha)
VALUES
    ('123.456.789-01', 'exemplo@email.com', 'Rua Exemplo 123', '12345-678', '12345678', '1990-01-01', 'senha123'),
    ('987.654.321-09', 'outro@email.com', 'Avenida Outra 456', '54321-876', '98765432', '1985-02-15', 'outrasenha456');
...
BEGIN
    INSERT INTO `nodebounty`.`clientes` (CPF, EMAIL, ENDERECO, CEP, RG, DATANASCIMENTO, SENHA)
    VALUES (V_CPF, V_EMAIL, V_ENDERECO, V_CEP, V_RG, V_DATANASCIMENTO, V_SENHA);
END$$
DELIMITER ;
...
CALL INSERIR_CLIENTE('987.123.456-78', 'novo_cliente@email.com', 'Rua Nova 789', '98765-432', '98765431', '1988-09-10', 'senha123');
SELECT * FROM clientes;

CALL ATUALIZAR_CLIENTE(1, '517.625.589-52', 'novo@email.com', 'Novo Endereco', '54321-987', '56856235', '2000-05-20', 'novaSenha');
SELECT * FROM clientes;

CALL EXCLUIR_CLIENTE(3);
SELECT * FROM clientes;
/*------------------//------------------03------------------//*/
